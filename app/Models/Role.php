...
class Role extends Model
{
    ...
    protected $casts = [
        ...
        'analytics_orders_access' => 'boolean',
        'analytics_orders_show_kpi' => 'boolean',
        'analytics_orders_show_charts' => 'boolean',
        'analytics_orders_show_tables' => 'boolean',
        'analytics_orders_finance_access' => 'boolean',
        ...
        'orders_payments_overpayment' => 'boolean',
        'orders_payments_edit' => 'boolean',
        'orders_clients_manage' => 'boolean',
        'orders_clients_create' => 'boolean',
        'orders_clients_edit' => 'boolean',
        'orders_clients_payments' => 'boolean',
        'orders_clients_overpayments_manage' => 'boolean',
        'orders_clients_payments_edit' => 'boolean',

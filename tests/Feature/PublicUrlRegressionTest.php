...
class PublicUrlRegressionTest extends TestCase
{
    ...
    private function rolePayload(array $overrides = []): array
    {
        $payload = [
            ...
            'analytics_orders_show_kpi' => '0',
            'analytics_orders_show_charts' => '0',
            'analytics_orders_show_tables' => '0',
            'analytics_orders_finance_access' => '0',
            'can_orders' => '0',
            ...
            'orders_update' => '0',
            'orders_payments' => '0',
            'orders_payments_overpayment' => '0',
            'orders_payments_edit' => '0',
            'orders_clients_manage' => '0',
            'orders_clients_create' => '0',
            'orders_clients_edit' => '0',
            'orders_clients_payments' => '0',
            'orders_clients_overpayments_manage' => '0',
            'orders_clients_payments_edit' => '0',
            'can_price' => '0',
            'price_create_item' => '0',
